    ...
    <InstructionsModal
      ...
      cardProps={[
        ...
        },
        {
          ...
          description: `If you’re lucky enough to win your NFT auction, you’ll have to redeem it to add it to your wallet. This can be done from the auction, winning notification, or your profile on FaceEffects.`,
